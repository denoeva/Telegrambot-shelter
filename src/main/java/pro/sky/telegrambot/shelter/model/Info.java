...
public final class Info {
    ...
    public static final String DOCS = "\uD83D\uDCC4 Список документов, необходимых для того, чтобы взять животное из приюта:\n" +
        ...
        public static final String REPORT_FORM = "Дорогой усыновитель, пожалуйста, пришли отчет в следующей форме:\n" +
                ...
                "ℹ\uFE0FОбязательно прикрепи фото животного в том же сообщении." +
                "\n(Каждый пункт с нумерацией и красной строки)" +
                "\nИ не забывай, что отчет нужно присылать каждый день до 21:00.";

        public static final String INFO_AFTER_ATTACHMENT = "Поздравляем!\nВам доверили животное!\n" + "Заботьтесь о нем с любовью!\nА мы будем наблюдать за этим\uD83D\uDE09" +
                "\nПоэтому будем ждать от вас ежедневный отчет в форме:\n" +
                "\nНомер отчета:\n1. Рацион животного.\n" +
                "2. Общее самочувствие и привыкание к новому месту.\n" +
                "3. Изменение в поведении: отказ от старых привычек, приобретение новых.\n" +
                "ℹ\uFE0FОбязательно прикрепи фото животного в том же сообщении, и не забывай, что отчет нужно присылать до 21:00.";
        ...
        public static final String CONFLICT_REPORT = "\u2753\u2753\u2753 Возникла ошибка\n(Оформление не соответствует)\n" +
                "\nСначала выберите раздел:\n          \n\uD83D\uDDD2 Сдать отчет\n" +
                "\nДальше запишите согласно образцу:\n" +
                "\nНомер отчета:" +
                "\n1. Рацион животного ..." +
                "\n2. Общее самочувствие и привыкание ..." +
                "\n3. Изменение в поведении ..." +
                "\nℹ\uFE0FОбязательно прикрепите фото животного в том же сообщении.\n" +
                "\n(Каждый пункт с нумерацией и красной строки)";
        public static final String PHOTO_REQUIRED = "Мы не можем принять Ваш отчет без фото.\nПожалуйста, прикрепите фото животного к Вашему сообщению";

        public static final String REPORT_INFO_REQUIRED = "Кажется, в Вашем отчете не хватает информации о рационе или состоянии питомца. Пожалуйста, придерживайтесь стандартной форма отчета:\n" +
                "\nОтчет:\n1. Рацион животного.\n" +
                "2. Общее самочувствие и привыкание к новому месту.\n" +
                "3. Изменение в поведении: отказ от старых привычек, приобретение новых.\n" +
                "ℹ\uFE0FОбязательно прикрепите фото животного в том же сообщении.";
        public static final String REPORT_ACCEPTED_FOR_CHECKING = "Спасибо!\uD83E\uDD0D Мы отправили Ваш отчет волонтеру, он свяжется с Вами, если потребуется больше информации.";

        public static final String NEW_REPORT = "\bНовый ежедневный отчет.\b\nПожалуйста, проверьте отчет о состоянии животного!\nДля принятия ответа нажмите: Принять отчет" +
                "\nЕсли отчет требует доработки, то нажмите соответствующую кнопку\n";

        public static final String REPORT_REJECTED = "Волонтер просит Вас доработать последний отчет. Пожалуйста, придерживайтесь стандартной форме отчета:\n" +
                "\nНомер отчета:" +
                "\n1. Рацион животного.\n" +
                "2. Общее самочувствие и привыкание к новому месту.\n" +
                "3. Изменение в поведении: отказ от старых привычек, приобретение новых.\n" +
