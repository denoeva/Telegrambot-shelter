...
public final class Info {
    ...
    public static final String DOCS = "\uD83D\uDCC4 Список документов, необходимых для того, чтобы взять животное из приюта:\n" +
        ...
        public static final String REPORT_FORM = "Дорогой усыновитель, пожалуйста, пришли отчет в следующей форме:\n" +
                ...
                "Обязательно прикрепи фото животного в том же сообщении, и не забывай, что отчет нужно присылать каждый день до 21:00.";
        ...
        public static final String INFO_AFTER_ATTACHMENT = "Поздравляем! Вам доверили животное!\n" + "Заботьтесь о нем с любовью! А мы будем наблюдать за этим\uD83D\uDE09. " +
                ...
                "2. Общее самочувствие и привыкание к новому месту.\n" +
                "3. Изменение в поведении: отказ от старых привычек, приобретение новых.\n" +
                "Обязательно прикрепи фото животного в том же сообщении, и не забывай, что отчет нужно присылать до 21:00.";
        ...
        public static final String REPORT_INFO_REQUIRED = "Кажется, в Вашем отчете не хватает информации о рационе или состоянии питомца. Пожалуйста, придерживайтесь стандартной форма отчета:\n" +
                ...
                "2. Общее самочувствие и привыкание к новому месту.\n" +
                "3. Изменение в поведении: отказ от старых привычек, приобретение новых.\n" +
                "Обязательно прикрепите фото животного в том же сообщении.";
        ...
        public static final String NEW_REPORT = "\bНовый ежедневный отчет.\b\nПожалуйста, проверьте отчет о состоянии животного!\nДля принятия ответа нажмите Принять. Если отчет требует доработки, то нажмите соответствующую кнопку.";

        public static final String REPORT_REJECTED = "Волонтер просит Вас доработать последний отчет. Пожалуйста, придерживайтесь стандартной форма отчета:\n" +
                "\nОтчет:\n1. Рацион животного.\n" +
                "2. Общее самочувствие и привыкание к новому месту.\n" +
                "3. Изменение в поведении: отказ от старых привычек, приобретение новых.\n" +
                "Обязательно прикрепите фото животного в том же сообщении.";
